...
MongoClient.connect(url, (error, db) => {
    ...
    // Get documents that match the condition from the collection.
...
$(function() {
    ...
    /* append() */
    var append = $('#method-append');
    append.click(function() {
        var dom = '<tr><td><div class="checkbox"><label><input type="checkbox" value=""></label></div></td><td>test</td>';
        var $target = append.find('table-content');
        $target.append(dom);
    });
